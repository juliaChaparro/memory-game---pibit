...
export type GetGameSessionAggregateType<T extends GameSessionAggregateArgs> = {
    [P in keyof T & keyof AggregateGameSession]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateGameSession[P]> : Prisma.GetScalarType<T[P], AggregateGameSession[P]>;
};
...
export type GetGameSessionGroupByPayload<T extends GameSessionGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<GameSessionGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof GameSessionGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], GameSessionGroupByOutputType[P]> : Prisma.GetScalarType<T[P], GameSessionGroupByOutputType[P]>;
}>>;
export type GameSessionWhereInput = {
    ...
    modo?: Prisma.IntFilter<"GameSession"> | number;
    pares?: Prisma.IntFilter<"GameSession"> | number;
    tempo?: Prisma.IntFilter<"GameSession"> | number;
    pontuacao?: Prisma.IntFilter<"GameSession"> | number;
    erros?: Prisma.IntFilter<"GameSession"> | number;
    createdAt?: Prisma.DateTimeFilter<"GameSession"> | Date | string;
};
export type GameSessionOrderByWithRelationInput = {
    id?: Prisma.SortOrder;
    modo?: Prisma.SortOrder;
    pares?: Prisma.SortOrder;
...
export type GameSessionScalarWhereWithAggregatesInput = {
    ...
    modo?: Prisma.IntWithAggregatesFilter<"GameSession"> | number;
    pares?: Prisma.IntWithAggregatesFilter<"GameSession"> | number;
    tempo?: Prisma.IntWithAggregatesFilter<"GameSession"> | number;
    pontuacao?: Prisma.IntWithAggregatesFilter<"GameSession"> | number;
    erros?: Prisma.IntWithAggregatesFilter<"GameSession"> | number;
...
export type GameSessionUpdateInput = {
    modo?: Prisma.IntFieldUpdateOperationsInput | number;
    pares?: Prisma.IntFieldUpdateOperationsInput | number;
...
export type GameSessionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "modo" | "pares" | "tempo" | "pontuacao" | "erros" | "createdAt", ExtArgs["result"]["gameSession"]>;
...
export type GameSessionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<GameSessionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface GameSessionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends GameSessionCountArgs>(args?: Prisma.Subset<T, GameSessionCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], GameSessionCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends GameSessionGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, GameSessionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetGameSessionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface GameSessionFieldRefs {
    ...
    readonly modo: Prisma.FieldRef<"GameSession", 'Int'>;
    readonly pares: Prisma.FieldRef<"GameSession", 'Int'>;
    readonly tempo: Prisma.FieldRef<"GameSession", 'Int'>;
    readonly pontuacao: Prisma.FieldRef<"GameSession", 'Int'>;
    readonly erros: Prisma.FieldRef<"GameSession", 'Int'>;
